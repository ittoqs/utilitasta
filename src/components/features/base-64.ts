...
export function fromBase64(value: string): string {
  try {
    ...
    if (lines.length > 1) {
      ...
      // Beberapa string base64 independen (satu per baris) terdekode menjadi
      // output yang sama sebagai baris pertama ketika digabungkan; input berbalut gaya PEM tidak.
